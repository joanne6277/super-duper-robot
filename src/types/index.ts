...
// --- 圖服部合約相關介面 (從 TuFuFields 移植) ---

export interface CheckboxWithTextData {
  selected: string;
  details: string;
}

export interface DropdownWithTextData {
  selected: string;
  details: string;
}

export interface PercentageWithTextData {
  percentage: string;
  details: string;
}
